...
- Name: generate-screenshots.spec.ts >> Automated Screenshot Generator for All TA Test Cases >> TC-02a & TC-02b: Logout & Middleware Redirect
- Location: tests\e2e\generate-screenshots.spec.ts:110:3
...
Call log:
  - waiting for locator('.header-logout-btn').first()
