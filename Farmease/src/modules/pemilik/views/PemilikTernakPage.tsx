...
import DasborPemilikPeternakanView from './DasborPemilikPeternakanView';
import KandangTugasView from './KandangTugasView';
import GrafikDombaView from './GrafikDombaView';

export default defineComponent({
  name: 'PemilikTernakPage',
  setup() {
    const isSidebarOpen = ref(false);
    const activeTab = ref<string>('dasbor');
          ...
          <div class="admin-layout-container">
            ...
            <aside class={['admin-sidebar', isSidebarOpen.value ? 'open' : '']}>
              ...
              <div class="sidebar-profile">
                ...
                <div class="profile-info">
                  ...
                  <span class="profile-role">Pemilik Peternakan</span>
                </div>
              </div>

              <hr class="sidebar-divider" />

              {/* Menu — Pemilik dengan 3 Halaman */}
              <div class="sidebar-menu-wrapper">
                <div class="menu-category">
                  <span class="category-label">Utama</span>
                  <button
                    type="button"
                    class={['menu-item', activeTab.value === 'dasbor' ? 'active' : '']}
                    onClick={() => { activeTab.value = 'dasbor'; isSidebarOpen.value = false; }}
                  >
                    <img src="/icon/dashboard/green-24.svg" alt="Dasbor" class="menu-icon" />
                  ...
                  >
                    ...
                    <span>Kandang & Tugas</span>
                  </button>
                  <button
                    type="button"
                    class={['menu-item', activeTab.value === 'grafik' ? 'active' : '']}
                    onClick={() => { activeTab.value = 'grafik'; isSidebarOpen.value = false; }}
                  >
                    <img src="/icon/schedule/green-24.svg" alt="Grafik" class="menu-icon" />
            ...
            <div class="admin-main-content">
              <div class="admin-content-inner">
                {activeTab.value === 'dasbor' && <DasborPemilikPeternakanView />}
                {activeTab.value === 'kandang' && <KandangTugasView />}
                {activeTab.value === 'grafik' && <GrafikDombaView />}
              </div>
            </div>
