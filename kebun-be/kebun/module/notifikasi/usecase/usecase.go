...
func (u *notifikasiUsecase) FindByID(ctx context.Context, id string) (*domain.Notifikasi, error) {
...
func (u *notifikasiUsecase) Delete(ctx context.Context, id string) error {
