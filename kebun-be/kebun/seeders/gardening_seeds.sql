...
('sub-obat-001', 'pemberian obat', 'Pemberian Obat', 'PK001', 'Operator Kebun', 'L001', 'pohon', 'Mencatat Pemberian Pestisida', '{"data": {"items": [{"kodePohon": "LA001", "namaOPT": "Tungau Merah", "namaObat": "Minyak sereh wangi", "jenisObat": "Pestisida", "volumeObat": "2", "satuanVolumeObat": "Mililiter (ml)", "deskripsiPerawatan": "Semprot Tungau Merah"}]}}'::jsonb, 'approved', NOW() - INTERVAL '8 days'),
('sub-stok-obat-001', 'stok obat', 'Stok Obat', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Obat Insektisida (Beauveria bassiana)', '{"data": {"items": [{"namaObat": "Beauveria bassiana", "tipeStok": "baru", "jenisObat": "Insektisida", "volumeObat": "2000", "satuanVolumeObat": "Gram (g)", "namaOPT": "Hama Insekta / Ulat / Penggerek", "tanggalKadaluarsa": "2027-10-10"}]}}'::jsonb, 'approved', NOW() - INTERVAL '6 days'),
...
('sub-stok-pupuk-002', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Pupuk Baru (Urea)', '{"data": {"items": [{"namaObat": "Urea", "tipeStok": "baru", "jenisPupuk": "Pupuk Kimia", "volumeObat": "50", "satuanVolumeObat": "Kilogram (Kg)", "tujuanPemanfaatan": "pupuk", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
('sub-stok-pupuk-005', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Pupuk Baru (SP-36)', '{"data": {"items": [{"namaObat": "SP-36", "tipeStok": "baru", "jenisPupuk": "Pupuk Kimia", "volumeObat": "50", "satuanVolumeObat": "Kilogram (Kg)", "tujuanPemanfaatan": "pupuk", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
('sub-stok-pupuk-006', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Pupuk Baru (KCl)', '{"data": {"items": [{"namaObat": "KCl", "tipeStok": "baru", "jenisPupuk": "Pupuk Kimia", "volumeObat": "50", "satuanVolumeObat": "Kilogram (Kg)", "tujuanPemanfaatan": "pupuk", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
...
('sub-stok-pupuk-004', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Pupuk Baru (POC Air Cucian Beras)', '{"data": {"items": [{"namaObat": "POC Air Cucian Beras", "tipeStok": "baru", "jenisPupuk": "Pupuk Organik Cair", "volumeObat": "10", "satuanVolumeObat": "Liter (L)", "tujuanPemanfaatan": "pupuk", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
...
('sub-stok-bahan-003', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Bahan (Air cucian beras)', '{"data": {"items": [{"namaObat": "Air cucian beras (Metode Ragi Tape & Air Kelapa)", "tipeStok": "baru", "jenisPupuk": "Pupuk Organik Cair", "volumeObat": "50", "satuanVolumeObat": "Liter (L)", "tujuanPemanfaatan": "bahan", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
('sub-stok-bahan-004', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Bahan (Air Kelapa)', '{"data": {"items": [{"namaObat": "Air Kelapa", "tipeStok": "baru", "jenisPupuk": "Pupuk Organik Cair", "volumeObat": "20", "satuanVolumeObat": "Liter (L)", "tujuanPemanfaatan": "bahan", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
('sub-stok-bahan-005', 'stok pupuk', 'Stok Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Stok Bahan (Gula Merah)', '{"data": {"items": [{"namaObat": "Gula Merah", "tipeStok": "baru", "jenisPupuk": "Pupuk Organik Padat", "volumeObat": "5", "satuanVolumeObat": "Kilogram (Kg)", "tujuanPemanfaatan": "bahan", "tanggalKadaluarsa": "2027-12-31"}]}}'::jsonb, 'approved', NOW() - INTERVAL '4 days'),
('sub-fermentasi-001', 'pengolahan pupuk', 'Pengolahan Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Fermentasi POC Air Cucian Beras', '{"data": {"items": [{"id": "fer-batch-001", "selectedRincian": "Fermentasi Pupuk", "hasilJadi": "POC Air Cucian Beras", "qty": "10", "unit": "Liter", "bahanMentahId": "Air cucian beras (Metode Ragi Tape & Air Kelapa)", "bahanUtama": "Air cucian beras", "bahanUtamaQty": "10", "bahanUtamaUnit": "Liter", "dekomposer": "EM4", "dekomposerQty": "100", "dekomposerUnit": "mL", "molase": "Gula Merah", "molaseQty": "0.25", "molaseUnit": "kg", "adaBahanTambahan": "ya", "bahanTambahanItems": [{"nama": "Air Kelapa", "qty": "1.0", "unit": "Liter"}, {"nama": "Ragi Tape", "qty": "1", "unit": "butir"}], "jumlahAir": "10", "satuanVolumeAir": "Liter (L)"}]}}'::jsonb, 'approved', NOW() - INTERVAL '5 days'),
('sub-cek-fermentasi-001', 'pengolahan pupuk', 'Pengolahan Pupuk', 'PK001', 'Operator Kebun', 'L001', 'lahan', 'Mencatat Cek Fermentasi - Siap Digunakan', '{"data": {"items": [{"selectedRincian": "Cek Fermentasi", "jenisFermentasi": "Pupuk Organik Cair (POC)", "batchFermentasiId": "fer-batch-001", "aktivitasPengecekan": "Panen / Ready", "kondisiFisik": "Siap Digunakan", "siapGuna": "siap", "hasilJadi": "POC Air Cucian Beras", "qty": "10", "unit": "Liter"}]}}'::jsonb, 'approved', NOW() - INTERVAL '1 days');
