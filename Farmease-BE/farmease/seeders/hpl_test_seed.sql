...
('55555555-5555-5555-5555-555555555591', 'J-01', 'Pejantan J-01', 'jantan', '2022-06-01', 'aktif', 'lokal', '33333333-3333-3333-3333-333333333305', '22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111101'),
('55555555-5555-5555-5555-555555555592', 'B-01', 'Indukan B-01', 'betina', '2022-06-01', 'hamil', 'lokal', '33333333-3333-3333-3333-333333333302', '22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111101'),
('55555555-5555-5555-5555-555555555502', 'XG893', 'Mak Bocil', 'betina', '2024-01-14', 'hamil', 'lokal', '33333333-3333-3333-3333-333333333302', '22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111101')
ON CONFLICT (sheep_code) DO UPDATE 
SET status = EXCLUDED.status,
    id_cage = EXCLUDED.id_cage;
