...
This directory contains shared libraries and utilities used across the `github.com/farmease/farmease-be/farmease` application. These libraries provide standardized implementations for common patterns, error handling, logging, and infrastructure integrations.
